...
</div></details><br></div></details><details><summary><b>[95] Sinar-ReversedBold.otf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Checking OS/2 usWinAscent & usWinDescent. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/universal.html#com.google.fonts/check/family/win_ascent_and_descent">com.google.fonts/check/family/win_ascent_and_descent</a>)</summary><div>
...
>
* 🔥 **FAIL** OS/2.usWinDescent value 960 is too large. It should be less than double the yMin. Current absolute yMin value is 266 [code: descent]
...
>
* ⚠ **WARN** The most common width is 478 among a set of 9 math glyphs.
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* numbersign (U+0023): X=206.0,Y=-1.0 (should be at baseline 0?)

	* numbersign (U+0023): X=471.0,Y=-1.0 (should be at baseline 0?)

	* asterisk (U+002A): X=302.0,Y=702.0 (should be at cap-height 700?)

	* colon (U+003A): X=55.0,Y=2.0 (should be at baseline 0?)

	* W (U+0057): X=229.0,Y=-2.0 (should be at baseline 0?)

	* W (U+0057): X=337.0,Y=-2.0 (should be at baseline 0?)

	* W (U+0057): X=666.0,Y=-2.0 (should be at baseline 0?)

	* W (U+0057): X=776.0,Y=-2.0 (should be at baseline 0?)

	* asciicircum (U+005E): X=297.0,Y=698.0 (should be at cap-height 700?)

	* g (U+0067): X=296.0,Y=507.0 (should be at x-height 506?) 
...
* ⚠ **WARN** The following glyphs have colinear vectors:
	...
	* numbersign (U+0023): L<<252.0,441.0>--<223.0,351.0>> -> L<<223.0,351.0>--<192.0,277.0>>

	* numbersign (U+0023): L<<515.0,441.0>--<486.0,351.0>> -> L<<486.0,351.0>--<455.0,277.0>>

	* oneeighth (U+215B): L<<149.0,406.0>--<149.0,614.0>> -> L<<149.0,614.0>--<155.0,701.0>>

	* onehalf (U+00BD): L<<149.0,406.0>--<149.0,614.0>> -> L<<149.0,614.0>--<155.0,701.0>>

	* onequarter (U+00BC): L<<149.0,406.0>--<149.0,614.0>> -> L<<149.0,614.0>--<155.0,701.0>>

	* uni00B9 (U+00B9): L<<149.0,533.0>--<149.0,742.0>> -> L<<149.0,742.0>--<155.0,829.0>>

	* uni2081 (U+2081): L<<149.0,-42.0>--<149.0,167.0>> -> L<<149.0,167.0>--<155.0,254.0>> 

	* uni2153 (U+2153): L<<149.0,406.0>--<149.0,614.0>> -> L<<149.0,614.0>--<155.0,701.0>> [code: found-colinear-vectors]
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* uni20BD (U+20BD): L<<32.0,329.0>--<154.0,330.0>>

	* uni25B3 (U+25B3): L<<599.0,93.0>--<191.0,92.0>>

	* uni25B7 (U+25B7): L<<173.0,146.0>--<172.0,554.0>>

	* uni25BD (U+25BD): L<<191.0,608.0>--<599.0,607.0>> 

	* uni25C1 (U+25C1): L<<618.0,554.0>--<617.0,146.0>> [code: found-semi-vertical]
