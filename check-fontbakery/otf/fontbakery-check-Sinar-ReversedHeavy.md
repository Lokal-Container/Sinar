...
</div></details><br></div></details><details><summary><b>[95] Sinar-ReversedHeavy.otf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Checking OS/2 usWinAscent & usWinDescent. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/universal.html#com.google.fonts/check/family/win_ascent_and_descent">com.google.fonts/check/family/win_ascent_and_descent</a>)</summary><div>
...
>
* 🔥 **FAIL** OS/2.usWinDescent value 960 is too large. It should be less than double the yMin. Current absolute yMin value is 275 [code: descent]
...
>
* ⚠ **WARN** The most common width is 482 among a set of 9 math glyphs.
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* exclam (U+0021): X=77.0,Y=2.0 (should be at baseline 0?)

	* numbersign (U+0023): X=216.0,Y=-1.0 (should be at baseline 0?)

	* numbersign (U+0023): X=493.0,Y=-1.0 (should be at baseline 0?)

	* dollar (U+0024): X=351.0,Y=-2.0 (should be at baseline 0?)

	* period (U+002E): X=52.0,Y=2.0 (should be at baseline 0?)

	* question (U+003F): X=163.0,Y=2.0 (should be at baseline 0?)

	* asciicircum (U+005E): X=317.0,Y=698.0 (should be at cap-height 700?)

	* g (U+0067): X=300.0,Y=512.0 (should be at x-height 510?)

	* p (U+0070): X=224.0,Y=509.0 (should be at x-height 510?)

	* t (U+0074): X=98.0,Y=509.0 (should be at x-height 510?) 
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	...
	* M (U+004D) contains a short segment L<<238.0,433.0>--<260.0,433.0>>

	* M (U+004D) contains a short segment L<<677.0,433.0>--<699.0,433.0>>

	* M (U+004D) contains a short segment L<<482.0,204.0>--<454.0,204.0>>

	* V (U+0056) contains a short segment L<<598.0,841.0>--<586.0,846.0>>

	* V (U+0056) contains a short segment L<<93.0,846.0>--<81.0,841.0>>

	* W (U+0057) contains a short segment L<<742.0,209.0>--<710.0,209.0>>

	* W (U+0057) contains a short segment L<<302.0,209.0>--<270.0,209.0>>

	* b (U+0062) contains a short segment L<<181.0,103.0>--<193.0,103.0>>

	* m (U+006D) contains a short segment L<<203.0,387.0>--<203.0,409.0>>

	* yen (U+00A5) contains a short segment L<<541.0,269.0>--<533.0,280.0>> 
...
* ⚠ **WARN** The following glyphs have colinear vectors:
	...
	* numbersign (U+0023): L<<233.0,425.0>--<209.0,351.0>> -> L<<209.0,351.0>--<185.0,293.0>>

	* numbersign (U+0023): L<<508.0,425.0>--<484.0,351.0>> -> L<<484.0,351.0>--<460.0,293.0>>

	* oneeighth (U+215B): L<<153.0,414.0>--<153.0,607.0>> -> L<<153.0,607.0>--<160.0,699.0>>

	* onehalf (U+00BD): L<<153.0,414.0>--<153.0,607.0>> -> L<<153.0,607.0>--<160.0,699.0>>

	* onequarter (U+00BC): L<<153.0,414.0>--<153.0,607.0>> -> L<<153.0,607.0>--<160.0,699.0>>

	* uni00B9 (U+00B9): L<<153.0,544.0>--<153.0,737.0>> -> L<<153.0,737.0>--<160.0,829.0>>

	* uni2081 (U+2081): L<<153.0,-31.0>--<153.0,162.0>> -> L<<153.0,162.0>--<160.0,254.0>> 

	* uni2153 (U+2153): L<<153.0,414.0>--<153.0,607.0>> -> L<<153.0,607.0>--<160.0,699.0>> [code: found-colinear-vectors]
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* uni20BD (U+20BD): L<<32.0,331.0>--<148.0,332.0>>

	* uni25B3 (U+25B3): L<<563.0,113.0>--<227.0,112.0>>

	* uni25B7 (U+25B7): L<<193.0,182.0>--<192.0,518.0>>

	* uni25BD (U+25BD): L<<227.0,588.0>--<563.0,587.0>> 

	* uni25C1 (U+25C1): L<<598.0,518.0>--<597.0,182.0>> [code: found-semi-vertical]
