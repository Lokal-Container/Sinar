...
>
* 🔥 **FAIL** OS/2.usWinDescent value 960 is too large. It should be less than double the yMin. Current absolute yMin value is 267 [code: descent]
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* exclam (U+0021): X=138.5,Y=702.0 (should be at cap-height 700?)

	* exclam (U+0021): X=92.0,Y=-1.0 (should be at baseline 0?)

	* exclam (U+0021): X=92.0,Y=-1.0 (should be at baseline 0?)

	* numbersign (U+0023): X=356.0,Y=698.0 (should be at cap-height 700?)

	* numbersign (U+0023): X=606.0,Y=698.0 (should be at cap-height 700?)

	* numbersign (U+0023): X=418.0,Y=-1.0 (should be at baseline 0?)

	* numbersign (U+0023): X=168.0,Y=-1.0 (should be at baseline 0?)

	* percent (U+0025): X=201.0,Y=-2.0 (should be at baseline 0?)

	* percent (U+0025): X=602.0,Y=701.0 (should be at cap-height 700?)

	* asterisk (U+002A): X=262.0,Y=701.0 (should be at cap-height 700?) 
...
* ⚠ **WARN** The following glyphs have jaggy segments:
	...
	* trademark (U+2122): L<<711.0,400.0>--<712.0,391.0>>/L<<712.0,391.0>--<706.0,513.0>> = 3.5246350616986883 [code: found-jaggy-segments]
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* uni20BD (U+20BD): L<<157.0,328.0>--<34.0,327.0>>

	* uni20BD (U+20BD): L<<319.0,329.0>--<199.0,328.0>>

	* uni25B3 (U+25B3): L<<115.0,46.0>--<675.0,47.0>>

	* uni25B7 (U+25B7): L<<126.0,630.0>--<127.0,70.0>>

	* uni25BD (U+25BD): L<<675.0,653.0>--<115.0,654.0>> 

	* uni25C1 (U+25C1): L<<657.0,630.0>--<656.0,70.0>> [code: found-semi-vertical]
