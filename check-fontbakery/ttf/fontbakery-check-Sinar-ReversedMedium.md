...
</div></details><br></div></details><details><summary><b>[95] Sinar-ReversedMedium.ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Checking OS/2 usWinAscent & usWinDescent. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/universal.html#com.google.fonts/check/family/win_ascent_and_descent">com.google.fonts/check/family/win_ascent_and_descent</a>)</summary><div>
...
>
* 🔥 **FAIL** OS/2.usWinDescent value 960 is too large. It should be less than double the yMin. Current absolute yMin value is 274 [code: descent]
...
>
* ⚠ **WARN** The most common width is 474 among a set of 9 math glyphs.
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* exclam (U+0021): X=107.0,Y=-1.0 (should be at baseline 0?)

	* exclam (U+0021): X=107.0,Y=-1.0 (should be at baseline 0?)

	* numbersign (U+0023): X=449.0,Y=-1.0 (should be at baseline 0?)

	* numbersign (U+0023): X=197.0,Y=-1.0 (should be at baseline 0?)

	* asterisk (U+002A): X=289.0,Y=701.0 (should be at cap-height 700?)

	* period (U+002E): X=84.0,Y=-1.0 (should be at baseline 0?)

	* period (U+002E): X=84.0,Y=-1.0 (should be at baseline 0?)

	* slash (U+002F): X=477.0,Y=699.0 (should be at cap-height 700?)

	* one (U+0031): X=224.0,Y=699.0 (should be at cap-height 700?)

	* five (U+0035): X=75.0,Y=-2.0 (should be at baseline 0?) 
...
* ⚠ **WARN** The following glyphs have colinear vectors:
	...
	* numbersign (U+0023): L<<200.0,261.0>--<238.0,351.0>> -> L<<238.0,351.0>--<272.0,457.0>>

	* numbersign (U+0023): L<<451.0,261.0>--<488.0,351.0>> -> L<<488.0,351.0>--<523.0,457.0>>

	* oneeighth (U+215B): L<<150.0,703.0>--<144.0,622.0>> -> L<<144.0,622.0>--<144.0,397.0>>

	* onehalf (U+00BD): L<<150.0,703.0>--<144.0,622.0>> -> L<<144.0,622.0>--<144.0,397.0>>

	* onequarter (U+00BC): L<<150.0,703.0>--<144.0,622.0>> -> L<<144.0,622.0>--<144.0,397.0>>

	* uni00B9 (U+00B9): L<<150.0,828.0>--<144.0,747.0>> -> L<<144.0,747.0>--<144.0,522.0>>

	* uni2081 (U+2081): L<<150.0,253.0>--<144.0,172.0>> -> L<<144.0,172.0>--<144.0,-53.0>> 

	* uni2153 (U+2153): L<<150.0,703.0>--<144.0,622.0>> -> L<<144.0,622.0>--<144.0,397.0>> [code: found-colinear-vectors]
...
* ⚠ **WARN** The following glyphs have jaggy segments:
	...
	* guillemotleft (U+00AB): L<<151.0,199.0>--<185.0,177.0>>/L<<185.0,177.0>--<182.0,179.0>> = 0.7848246029917126 [code: found-jaggy-segments]
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* uni20B9 (U+20B9): L<<438.0,75.0>--<555.0,74.0>>

	* uni20BD (U+20BD): L<<159.0,328.0>--<33.0,327.0>>

	* uni25B3 (U+25B3): L<<155.0,71.0>--<635.0,72.0>>

	* uni25B7 (U+25B7): L<<151.0,590.0>--<152.0,110.0>>

	* uni25BD (U+25BD): L<<635.0,628.0>--<155.0,629.0>> 

	* uni25C1 (U+25C1): L<<639.0,590.0>--<638.0,110.0>> [code: found-semi-vertical]
